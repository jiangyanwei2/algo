...
public class DynamicProxyTest {
    public static void main(String[] args) {
        ...
        DataOperateInterface bondProxy = (DataOperateInterface)Proxy.newProxyInstance(DataOperateInterface.class.getClassLoader(), new Class[]{DataOperateInterface.class}, new DataDynamicProxy( new BondDataImpl()));
